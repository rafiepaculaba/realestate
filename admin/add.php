...
<head>
    ...
    <title>Admin Area - Listings</title>
</head>
    ...
    <section id="actions" class="py-4 mb-4 bg-light">
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-md-3">
                    <button name="add" title="add" class="btn btn-success" id="btn-add">
                      ...
                      <div class="card-body">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control" placeholder="Required">description here</textarea>
                            </div>
                        </form>
                      </div>
                  </div>
